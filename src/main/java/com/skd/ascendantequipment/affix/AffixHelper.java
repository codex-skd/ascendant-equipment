...
public class AffixHelper {
   public static final ResourceLocation AFFIX_CACHED_OBJECT = AscendantEquipment.loc("affixes");
   ...
   public static DynamicHolder<LootRarity> getRarity(ItemStack stack) {
      return stack.getOrDefault(AscEq.Components.RARITY, RarityRegistry.INSTANCE.emptyHolder());
   }
