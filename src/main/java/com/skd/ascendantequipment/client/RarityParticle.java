...
public class RarityParticle extends SingleQuadParticle {
   public RarityParticle(
      RarityParticleData data, ClientLevel level, double x, double y, double z, double velX, double velY, double velZ, TextureAtlasSprite sprite
   ) {
   ...
   public static class Provider implements ParticleProvider<RarityParticleData> {
      ...
      public Particle createParticle(
         RarityParticleData data, ClientLevel level, double x, double y, double z, double vx, double vy, double vz, RandomSource random
      ) {
