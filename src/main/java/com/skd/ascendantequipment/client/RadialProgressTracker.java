...
import com.skd.ascendantequipment.util.RadialUtil.RadialData;
import com.skd.ascendantequipment.util.RadialUtil.RadialState;
...
public class RadialProgressTracker {
    ...
    private static record CacheKey(BlockPos pos, ItemStack tool, Direction hitDir, Direction playerDir) {
    }
