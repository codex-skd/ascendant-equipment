...
import dev.shadowsoffire.gateways.gate.StandardWaveEntity.Builder;
...
public record PassengerWaveModifier(WaveEntity entity) implements WaveModifier {
   public static final Codec<PassengerWaveModifier> CODEC = RecordCodecBuilder.create(
      inst -> inst.group(WaveEntity.CODEC.fieldOf("entity").forGetter(PassengerWaveModifier::entity)).apply(inst, PassengerWaveModifier::new)
   );
   ...
   public static PassengerWaveModifier create(EntityType<?> type, UnaryOperator<Builder> config) {
