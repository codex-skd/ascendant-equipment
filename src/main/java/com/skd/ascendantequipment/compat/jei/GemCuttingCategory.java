...
public class GemCuttingCategory implements IRecipeCategory<GemCuttingRecipe> {
   public static final ResourceLocation TEXTURES = AscendantEquipment.loc("textures/gui/gem_cutting_jei.png");
   ...
   public GemCuttingCategory(IGuiHelper guiHelper) {
      ...
      this.icon = guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(AscEq.Blocks.GEM_CUTTING_TABLE.value()));
   }
