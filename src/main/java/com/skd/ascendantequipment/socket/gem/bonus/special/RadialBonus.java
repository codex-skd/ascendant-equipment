...
public class RadialBonus extends GemBonus {
   ...
   public static final Identifier GEM_RADIAL_DATA_CACHED_OBJECT = AscendantEquipment.loc("gem_radial_data");
   ...
   public static RadialUtil.RadialData getRadialData(ItemStack tool) {
      return (RadialUtil.RadialData)CachedObjectSource.getOrCreate(
         ...
         CachedObject.hashComponents(new DataComponentType[]{AscEq.Components.SOCKETED_GEMS, AscEq.Components.SOCKETS})
      );
   }
