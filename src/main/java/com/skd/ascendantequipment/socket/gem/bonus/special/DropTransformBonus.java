...
public class DropTransformBonus extends GemBonus {
   ...
   public DropTransformBonus(
      GemClass gemClass, ContextAwarePredicate conditions, Ingredient inputs, ItemStack output, Map<Purity, Float> values, String descKey
   ) {
      super(gemClass);
   ...
   public Component getSocketBonusTooltip(GemView inst, AttributeTooltipContext ctx) {
      ...
      return Component.translatable(this.descKey, Affix.fmt(chance * 100.0F)).withStyle(ChatFormatting.YELLOW);
   }
   ...
   public static class Builder extends GemBonus.Builder {
      ...
      public DropTransformBonus.Builder output(ItemStack output) {
