...
public class AffixHookLootModifier extends LootModifier {
   ...
   public AffixHookLootModifier(LootItemCondition[] conditions) {
      super(conditions);
   }
   ...
   protected ObjectArrayList<ItemStack> doApply(ObjectArrayList<ItemStack> generatedLoot, LootContext ctx) {
      ...
      } else if (ctx.getParamOrNull(LootContextParams.DIRECT_ATTACKING_ENTITY) instanceof LivingEntity living) {
