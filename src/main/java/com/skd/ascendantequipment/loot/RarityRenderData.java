...
public record RarityRenderData(
   ...
   public static class Builder {
      ...
      public RarityRenderData.Builder beamTexture(ResourceLocation texture) {
      ...
      public RarityRenderData.Builder glowTexture(ResourceLocation texture) {
   ...
   public record ShadowData(float size, int alpha, ResourceLocation texture, int frames, float frameTime) {
      ...
      public static final Codec<RarityRenderData.ShadowData> CODEC = RecordCodecBuilder.create(
         instance -> instance.group(
               ...
               ResourceLocation.CODEC.fieldOf("texture").forGetter(RarityRenderData.ShadowData::texture),
      ...
      public static class Builder {
         ...
         public RarityRenderData.ShadowData.Builder texture(ResourceLocation texture) {
