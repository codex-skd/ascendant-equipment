...
public record LootPatternMatcher(Optional<String> domain, Pattern pathRegex) implements LootItemCondition {
    public static final MapCodec<LootPatternMatcher> CODEC = RecordCodecBuilder.mapCodec(
        inst -> inst.group(
   ...
   public LootItemConditionType getType() {
      return AscEq.LootConditions.LOOT_TABLE_PATTERN_MATCHER;
   }

    public static Builder matchesTables(String domain, String regex) {
