...
public record PresetSpawnerStats(Map<SpawnerStat<?>, Object> stats) {
    public static final Codec<PresetSpawnerStats> CODEC = Codec.<SpawnerStat<?>, Object>dispatchedMap(SpawnerStats.REGISTRY.byNameCodec(), SpawnerStat::valueCodec).xmap(PresetSpawnerStats::new, PresetSpawnerStats::stats);
    ...
    public void apply(SpawnerTile entity) {
