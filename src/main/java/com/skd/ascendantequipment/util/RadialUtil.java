...
public class RadialUtil {
    ...
    public static void toggleRadialState(Player player) {
        ...
        player.sendSystemMessage(AscendantEquipment.sysMessageHeader().append(AscendantEquipment.lang("misc", "radial_state_updated", next.toComponent(), state.toComponent()).withStyle(ChatFormatting.YELLOW)));
