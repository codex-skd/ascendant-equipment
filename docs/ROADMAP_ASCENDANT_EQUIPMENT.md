...
Próximo paso: resto de la **Fase 15** — contenido data-driven JSON (recetas, tags, advancements JSON, loot tables bajo `data/apotheosis/` → `data/ascendant_equipment/`) y adaptación de `PatchouliCompat.java`/libro de guía a la API real de Vellumli.
