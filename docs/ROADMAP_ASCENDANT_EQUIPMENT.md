...
**Fase 15 completa**: todo el contenido data-driven de Apotheosis (mecánico + libro de guía) está portado. Próximo paso: **Fase 16** (arte propio — sustituir placeholders por texturas/modelos/sonidos/estructuras NBT originales; no bloquea el resto) y **Fase 17** (QA de paridad funcional), per la instrucción de continuar de forma ininterrumpida.
